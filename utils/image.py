...
class Image:
    ...
    @classmethod
    async def build(cls, html: str, width: int | None = None, quality: int = 90) -> bytes:
    ...
    @classmethod
    async def render(cls, html: str, width: int | None = None, quality: int = 90) -> bytes:
        ...
        async with async_playwright() as playwright:
            ...
            try:
                page = await browser.new_page(viewport={"width": finalWidth, "height": cls.minHeight, "device_scale_factor": 1})
    ...
    @classmethod
    async def save(cls, html: str, outputPath: Path, width: int | None = None, quality: int = 90) -> Path:
    ...
    @classmethod
    def buildSync(cls, html: str, width: int | None = None, quality: int = 90) -> bytes:
